...
describe('WalletService', () => {
  ...
  describe('unlockWallet', () => {
    it('wallet should be updated', fakeAsync(() => {
      ...
      spyOn(WebWorkersHelper, 'ExcecuteWorker').and.returnValue(Observable.of({}));
      walletService.unlockWallet(inputWallet, someSeed);

      walletService.wallets.subscribe((wallets) => {
        expect(wallets[0].seed).toEqual(someSeed);
      });
    }));
